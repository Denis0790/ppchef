...
export default function SubscriptionPage() {
  ...
  return (
    <main style={{
      ...
      <div style={{ padding: "24px 18px 100px", display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {isPremium && expiresAt && (
          <div style={{
            ...
            <div style={{
              ...
              fontFamily: "'Montserrat', sans-serif", color: "#F8FFEE", opacity: 0.7,
            }}>
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 12, fontWeight: 400, fontStyle: "normal",
            fontFamily: "'Montserrat', sans-serif",
            color: "#F8FFEE", opacity: 0.5, marginBottom: 14,
          }}>
            3 рубля в день
          </div>
          <button
        ...
        <div style={{
          ...
          <div style={{
            fontSize: 12, fontWeight: 400, fontStyle: "normal",
            fontFamily: "'Montserrat', sans-serif",
            color: "#F8FFEE", opacity: 0.7, marginBottom: 14,
          }}>
            66 рублей в месяц
          </div>
